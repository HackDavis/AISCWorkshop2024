...
export default function MLProjects() {
  ...
  const mlModels = ['logistic_regression', 'k_nearest_neighbors', 'support_vector_machine', 'decision_tree', 'random_forest', 'gradient_boosting', 'naive_bayes', 'neural_network', 'ada_boost', 'xg_boost']
    ...
    <div className={styles.container}>
      <div className={styles.container_inside}>
        <div className={styles.container_inside_window}>
          ...
          <button onClick={() => buttonHandler(checkedModels)}>Run Models</button>
          <div className={styles.container_inside_window_Card}>
                <Graph />
          </div>
          <div className={styles.container_inside_window_Card}>
